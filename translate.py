...
from urllib.request import HTTPRedirectHandler, HTTPDefaultErrorHandler, HTTPError

### Hard-coded variables ###

api = os.environ['TRANSLATE_API_KEY']
...
class GoogleTranslator(object):
    ...
    def __init__(self):
        ...
        self._opener = urllib.request.build_opener(DefaultErrorHandler,
                                            RedirectHandler)
